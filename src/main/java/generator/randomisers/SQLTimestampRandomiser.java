...
public class SQLTimestampRandomiser implements IRandomiserFunctionality
{
    ...
    public void setRandomiserInstance(RandomiserInstance ri)
    {
        ...
        for(int i=1; i<=rangesNum; i++)
        {
            try
            {
                ...
                diffDays[i-1] = utils.getDayswithTime(gcFromField, gcToField);
            }
            catch(Exception e)
            {
