...
public class PanelLastnameRandomiser extends RandomiserPanel
{
    
    /** Creates new form PanelEmailGenerator */
    public PanelLastnameRandomiser()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel6.setText("Lastname seed:");

        txtLnameSeed.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                txtLnameSeedActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jLabel6)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(txtLnameSeed, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 46, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtLnameSeedActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_txtLnameSeedActionPerformed
    {//GEN-HEADEREND:event_txtLnameSeedActionPerformed
// TODO add your handling code here:
    }//GEN-LAST:event_txtLnameSeedActionPerformed

    public boolean isFormValid()
    {
        String name, lnameSeed;
        Integer nullField;
        int seed;
    ...
    {
        String name, description, lnameSeed;
        Integer nullField;        
        ...
        ri.setRandomiserType("LastnameRandomiser");
        ri.setName(name);
    ...
    public void initialise(RandomiserInstance ri)
    {
        ...
        txtLnameSeed.setText( (String)hashMap.get("LastnameSeedField") );
    }
