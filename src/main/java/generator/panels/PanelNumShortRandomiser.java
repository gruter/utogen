...
public class PanelNumShortRandomiser extends RandomiserPanel
{
    Logger logger = Logger.getLogger(PanelNumShortRandomiser.class);
    
    /** Creates new form PanelNumShortRandomiser */
    public PanelNumShortRandomiser()
    {
        initComponents();
    ...
    {//GEN-HEADEREND:event_btnAddActionPerformed
        ...
        if(srtValues[0].shortValue()>srtValues[1].shortValue())
        {
        ...
        for(int i = 0; i<rowCount; i++)
        {
            try
            {
                for(int k=0; k<3; k++)
                {
                    try
                    {
                        srtValues[k] = (Short) newModel.getValueAt(i,k);
                    }
                ...
                hashmap.put("toField"+i,""+ srtValues[1].shortValue() );
                hashmap.put("percentField"+i,""+ srtValues[2].shortValue() );
            }
            catch(Exception e)
            {
    ...
    public boolean isFormValid()
    {
        ...
        for(int i = 0; i<newModel.getRowCount(); i++)
        {
            ...
            catch(Exception e)
            {
                ...
                JOptionPane.showMessageDialog(this,"Values in the table should be numerical.","Required field",JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
        if(percent!=100)
