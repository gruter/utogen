...
public class PanelNumLongRandomiser extends RandomiserPanel
{
    ...
    {//GEN-HEADEREND:event_btnAddActionPerformed
        ...
        if(lValues[0].longValue()>lValues[1].longValue())
        {
        ...
        for(int i = 0; i<rowCount; i++)
        {
            try
            {
                for(int k=0; k<3; k++)
                {
                    try
                    {
                        longValues[k] = (Long) newModel.getValueAt(i,k);
                    }
                ...
                hashmap.put("toField"+i,""+ longValues[1].longValue() );
                hashmap.put("percentField"+i,""+ longValues[2].longValue() );
            }
            catch(Exception e)
            {
