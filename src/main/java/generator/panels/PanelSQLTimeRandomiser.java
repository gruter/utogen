...
public class PanelSQLTimeRandomiser extends RandomiserPanel
{
    ...
    public boolean isFormValid()
    {
        ...
        for(int i = 0; i<newModel.getRowCount(); i++)
        {
            try
            {
                ...
                dateFrom  = Time.valueOf(sDateFrom);
                dateTo    = Time.valueOf(sDateTo);
                
                if( dateFrom.getTime() > dateTo.getTime())
                {
                    JOptionPane.showMessageDialog(this,"From date has a higher value than To date.","Invalid data",JOptionPane.ERROR_MESSAGE);
                    return false;
                }
    ...
    public RandomiserInstance getRandomiserInstance()
    {
        ...
        ri.setRandomiserType("SQLTimeRandomiser");
    ...
    public void initialise(RandomiserInstance ri)
    {
        ...
        String sMax, sFromDate, sDateTo, sPercent, sNull;
        int    iMax;
        Object objValues[] = new Object[3];
        ...
        try
        {
            ...
            for(int i=0; i<iMax; i++)
            {
                ...
                objValues[0] = Time.valueOf(sFromDate);
                sDateTo =(String)hashmap.get("toField"+i);
                objValues[1] = Time.valueOf(sDateTo);
